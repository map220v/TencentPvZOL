package PVZ.Protocol
{
   ...
   public final class Dto_IdNum extends Message
   {
      ...
      public static const $MessageID:String = "PVZ.Protocol.Dto_IdNum";
      
      public static const ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Protocol.Dto_IdNum.id","id",1 << 3 | WireType.VARINT);
      
      public static const NUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Protocol.Dto_IdNum.num","num",2 << 3 | WireType.VARINT);
