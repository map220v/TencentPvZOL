package PVZ.Protocol
{
   ...
   public final class Dto_PuppetInfo extends Message
   {
      ...
      public static const $MessageID:String = "PVZ.Protocol.Dto_PuppetInfo";
      
      public static const BASEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Protocol.Dto_PuppetInfo.baseId","baseId",1 << 3 | WireType.VARINT);
      
      public static const EXP:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Protocol.Dto_PuppetInfo.exp","exp",2 << 3 | WireType.VARINT);
      
      public static const LEVEL:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Protocol.Dto_PuppetInfo.level","level",3 << 3 | WireType.VARINT);
      
      public static const STAR:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Protocol.Dto_PuppetInfo.star","star",4 << 3 | WireType.VARINT);
      
      public static const QUALITY:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Protocol.Dto_PuppetInfo.quality","quality",5 << 3 | WireType.VARINT);
      
      public static const ACTIVESKILL:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Protocol.Dto_PuppetInfo.activeSkill","activeSkill",6 << 3 | WireType.LENGTH_DELIMITED,Dto_PuppetSkillInfo);
      
      public static const PASSIVESKILL:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Protocol.Dto_PuppetInfo.passiveSkill","passiveSkill",7 << 3 | WireType.LENGTH_DELIMITED,Dto_PuppetSkillInfo);
