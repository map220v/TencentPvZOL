package PVZ.Cmd
{
   ...
   public final class Dto_ExpeditionFightRoleInfo extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Dto_ExpeditionFightRoleInfo";
      
      public static const ROLEID:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Dto_ExpeditionFightRoleInfo.roleId","roleId",1 << 3 | WireType.VARINT);
      
      public static const FIGHTSIDE:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Dto_ExpeditionFightRoleInfo.fightSide","fightSide",2 << 3 | WireType.LENGTH_DELIMITED,Dto_FightSideInfo);
      
      public static const CARDFORMATION:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Dto_ExpeditionFightRoleInfo.cardFormation","cardFormation",3 << 3 | WireType.LENGTH_DELIMITED,Dto_CardFormation);
      
      public static const POWER:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_ExpeditionFightRoleInfo.power","power",4 << 3 | WireType.VARINT);
      
      public static const PUPPETFORMATION:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Dto_ExpeditionFightRoleInfo.puppetFormation","puppetFormation",5 << 3 | WireType.LENGTH_DELIMITED,PVZ.Protocol.Dto_PuppetFormation);
      ...
      public function Dto_ExpeditionFightRoleInfo()
      {
         super();
      }
      ...
      {
         return Dto_ExpeditionFightRoleInfo.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc8_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_ExpeditionFightRoleInfo.roleId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_ExpeditionFightRoleInfo.fightSide cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_ExpeditionFightRoleInfo.cardFormation cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_ExpeditionFightRoleInfo.power cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 5:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_ExpeditionFightRoleInfo.puppetFormation cannot be set twice.");
                  }
                  _loc7_++;
