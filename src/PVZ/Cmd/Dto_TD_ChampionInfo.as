package PVZ.Cmd
{
   ...
   public final class Dto_TD_ChampionInfo extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Dto_TD_ChampionInfo";
      
      public static const LEVELID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_TD_ChampionInfo.levelId","levelId",1 << 3 | WireType.VARINT);
      
      public static const SUBLEVELID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_TD_ChampionInfo.subLevelId","subLevelId",2 << 3 | WireType.VARINT);
      
      public static const CHALLENGELEVELID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_TD_ChampionInfo.challengeLevelId","challengeLevelId",3 << 3 | WireType.VARINT);
      
      public static const INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Dto_TD_ChampionInfo.info","info",4 << 3 | WireType.LENGTH_DELIMITED,Dto_TD_RankInfo);
      ...
      private var info$field:Dto_TD_RankInfo;
      
      public function Dto_TD_ChampionInfo()
      {
         super();
      }
      ...
      {
         return Dto_TD_ChampionInfo.$MessageID;
      }
      ...
      public function set info(param1:Dto_TD_RankInfo) : void
      {
         this.info$field = param1;
      }
      
      public function get info() : Dto_TD_RankInfo
      {
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc7_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TD_ChampionInfo.levelId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TD_ChampionInfo.subLevelId cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TD_ChampionInfo.challengeLevelId cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TD_ChampionInfo.info cannot be set twice.");
                  }
                  _loc6_++;
                  this.info = new Dto_TD_RankInfo();
