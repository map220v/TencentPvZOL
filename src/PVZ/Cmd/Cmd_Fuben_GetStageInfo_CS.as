package PVZ.Cmd
{
   ...
   public final class Cmd_Fuben_GetStageInfo_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Fuben_GetStageInfo_CS";
      
      public static const CHAPTERID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Fuben_GetStageInfo_CS.chapterid","chapterid",1 << 3 | WireType.VARINT);
      
      public static const MODEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Fuben_GetStageInfo_CS.modeid","modeid",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_Fuben_GetStageInfo_CS()
      {
         super();
      }
      ...
      {
         return Cmd_Fuben_GetStageInfo_CS.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Fuben_GetStageInfo_CS.chapterid cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Fuben_GetStageInfo_CS.modeid cannot be set twice.");
                  }
                  _loc4_++;
