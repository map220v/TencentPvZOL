package PVZ.Cmd
{
   ...
   public final class Cmd_ScrewUp_Fight_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_ScrewUp_Fight_CS";
      
      public static const STAGEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_ScrewUp_Fight_CS.stageId","stageId",1 << 3 | WireType.VARINT);
      
      public static const ISSWEEP:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("PVZ.Cmd.Cmd_ScrewUp_Fight_CS.isSweep","isSweep",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_ScrewUp_Fight_CS()
      {
         super();
      }
      ...
      {
         return Cmd_ScrewUp_Fight_CS.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ScrewUp_Fight_CS.stageId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ScrewUp_Fight_CS.isSweep cannot be set twice.");
                  }
                  _loc4_++;
