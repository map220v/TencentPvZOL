package PVZ.Cmd
{
   ...
   public final class Dto_AllServerRankArena_Recorder extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Dto_AllServerRankArena_Recorder";
      
      public static const REPORTUID:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Dto_AllServerRankArena_Recorder.reportUid","reportUid",1 << 3 | WireType.VARINT);
      
      public static const ENEMYROLEID:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Dto_AllServerRankArena_Recorder.enemyRoleId","enemyRoleId",2 << 3 | WireType.VARINT);
      
      public static const ENEMYNAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("PVZ.Cmd.Dto_AllServerRankArena_Recorder.enemyName","enemyName",3 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const ENEMYUIN:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_AllServerRankArena_Recorder.enemyUin","enemyUin",4 << 3 | WireType.VARINT);
      
      public static const ENEMYLEVEL:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_AllServerRankArena_Recorder.enemyLevel","enemyLevel",5 << 3 | WireType.VARINT);
      
      public static const ENEMYQQFACEURL:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("PVZ.Cmd.Dto_AllServerRankArena_Recorder.enemyQQFaceURL","enemyQQFaceURL",6 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const WIN:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("PVZ.Cmd.Dto_AllServerRankArena_Recorder.win","win",7 << 3 | WireType.VARINT);
      
      public static const ATTACK:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("PVZ.Cmd.Dto_AllServerRankArena_Recorder.attack","attack",8 << 3 | WireType.VARINT);
      
      public static const TIMESTAMP:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_AllServerRankArena_Recorder.timestamp","timestamp",9 << 3 | WireType.VARINT);
      ...
      private var enemyUin$field:uint;
      ...
      public function Dto_AllServerRankArena_Recorder()
      {
         super();
      }
      ...
      {
         return Dto_AllServerRankArena_Recorder.$MessageID;
      }
      ...
      public function clearEnemyUin() : void
      {
         this.hasField$0 &= 4294967294;
         this.enemyUin$field = new uint();
      }
      
      public function get hasEnemyUin() : Boolean
      {
         return (this.hasField$0 & 1) != 0;
      }
      
      public function set enemyUin(param1:uint) : void
      {
         this.hasField$0 |= 1;
         this.enemyUin$field = param1;
      }
      
      public function get enemyUin() : uint
      {
         return this.enemyUin$field;
      }
      ...
      override public final function writeToBuffer(param1:WritingBuffer) : void
      {
         ...
         if(this.hasEnemyUin)
         {
            ...
            WriteUtils.write$TYPE_UINT32(param1,this.enemyUin$field);
         }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc12_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_AllServerRankArena_Recorder.reportUid cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_AllServerRankArena_Recorder.enemyRoleId cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_AllServerRankArena_Recorder.enemyName cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_AllServerRankArena_Recorder.enemyUin cannot be set twice.");
                  }
                  _loc6_++;
                  this.enemyUin = ReadUtils.read$TYPE_UINT32(param1);
                  break;
               case 5:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_AllServerRankArena_Recorder.enemyLevel cannot be set twice.");
                  }
                  _loc7_++;
               ...
               case 6:
                  if(_loc8_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_AllServerRankArena_Recorder.enemyQQFaceURL cannot be set twice.");
                  }
                  _loc8_++;
               ...
               case 7:
                  if(_loc9_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_AllServerRankArena_Recorder.win cannot be set twice.");
                  }
                  _loc9_++;
               ...
               case 8:
                  if(_loc10_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_AllServerRankArena_Recorder.attack cannot be set twice.");
                  }
                  _loc10_++;
               ...
               case 9:
                  if(_loc11_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_AllServerRankArena_Recorder.timestamp cannot be set twice.");
                  }
                  _loc11_++;
