package PVZ.Cmd
{
   ...
   public final class Cmd_SignIn_SetInfo_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_SignIn_SetInfo_SC";
      
      public static const SIGNININFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_SignIn_SetInfo_SC.signInInfo","signInInfo",1 << 3 | WireType.LENGTH_DELIMITED,Dto_SignIn_Info);
       
      
      private var signInInfo$field:Dto_SignIn_Info;
      
      public function Cmd_SignIn_SetInfo_SC()
      {
         super();
      }
      ...
      {
         return Cmd_SignIn_SetInfo_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc4_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_SignIn_SetInfo_SC.signInInfo cannot be set twice.");
                  }
                  _loc3_++;
