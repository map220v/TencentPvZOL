package PVZ.Cmd
{
   ...
   public final class Dto_ExchangeInfo extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Dto_ExchangeInfo";
      
      public static const EXCHANGEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_ExchangeInfo.exchangeId","exchangeId",1 << 3 | WireType.VARINT);
      
      public static const COSTTICKET:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_ExchangeInfo.costTicket","costTicket",2 << 3 | WireType.VARINT);
      
      public static const ITEMID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_ExchangeInfo.itemId","itemId",3 << 3 | WireType.VARINT);
      
      public static const ITEMNUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_ExchangeInfo.itemNum","itemNum",4 << 3 | WireType.VARINT);
      
      public static const EXCHANGENUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_ExchangeInfo.exchangeNum","exchangeNum",5 << 3 | WireType.VARINT);
      
      public static const EXCHANGEDNUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_ExchangeInfo.exchangedNum","exchangedNum",6 << 3 | WireType.VARINT);
      ...
      public function Dto_ExchangeInfo()
      {
         super();
      }
      ...
      {
         return Dto_ExchangeInfo.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc9_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_ExchangeInfo.exchangeId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_ExchangeInfo.costTicket cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_ExchangeInfo.itemId cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_ExchangeInfo.itemNum cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 5:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_ExchangeInfo.exchangeNum cannot be set twice.");
                  }
                  _loc7_++;
               ...
               case 6:
                  if(_loc8_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_ExchangeInfo.exchangedNum cannot be set twice.");
                  }
                  _loc8_++;
