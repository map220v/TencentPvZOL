package PVZ.Cmd
{
   ...
   public final class Cmd_Card_BuyAvatar_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Card_BuyAvatar_SC";
      
      public static const CARDUID:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Cmd_Card_BuyAvatar_SC.cardUId","cardUId",1 << 3 | WireType.VARINT);
      
      public static const AVATARINFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_Card_BuyAvatar_SC.avatarInfo","avatarInfo",2 << 3 | WireType.LENGTH_DELIMITED,Dto_AvatarInfo);
      
      public static const AVATARALLATTR:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_Card_BuyAvatar_SC.avatarAllAttr","avatarAllAttr",3 << 3 | WireType.LENGTH_DELIMITED,Dto_AvatarAllAttr);
      ...
      public function Cmd_Card_BuyAvatar_SC()
      {
         super();
      }
      ...
      {
         return Cmd_Card_BuyAvatar_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc6_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Card_BuyAvatar_SC.cardUId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Card_BuyAvatar_SC.avatarInfo cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Card_BuyAvatar_SC.avatarAllAttr cannot be set twice.");
                  }
                  _loc5_++;
