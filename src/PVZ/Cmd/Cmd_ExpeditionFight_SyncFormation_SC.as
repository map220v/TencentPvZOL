package PVZ.Cmd
{
   ...
   public final class Cmd_ExpeditionFight_SyncFormation_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_ExpeditionFight_SyncFormation_SC";
      
      public static const FORMATION:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_ExpeditionFight_SyncFormation_SC.formation","formation",1 << 3 | WireType.LENGTH_DELIMITED,Dto_FormationInfo);
      
      public static const CITYID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_ExpeditionFight_SyncFormation_SC.cityId","cityId",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_ExpeditionFight_SyncFormation_SC()
      {
         super();
      }
      ...
      {
         return Cmd_ExpeditionFight_SyncFormation_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ExpeditionFight_SyncFormation_SC.formation cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ExpeditionFight_SyncFormation_SC.cityId cannot be set twice.");
                  }
                  _loc4_++;
