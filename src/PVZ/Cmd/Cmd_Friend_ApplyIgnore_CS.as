package PVZ.Cmd
{
   ...
   public final class Cmd_Friend_ApplyIgnore_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Friend_ApplyIgnore_CS";
      
      public static const FRIENDLIST:RepeatedFieldDescriptor$TYPE_INT64 = new RepeatedFieldDescriptor$TYPE_INT64("PVZ.Cmd.Cmd_Friend_ApplyIgnore_CS.friendList","friendList",1 << 3 | WireType.VARINT);
       
      
      public var friendList:Array;
      
      public function Cmd_Friend_ApplyIgnore_CS()
      {
         this.friendList = [];
         super();
      }
      ...
      {
         return Cmd_Friend_ApplyIgnore_CS.$MessageID;
      }
