package PVZ.Cmd
{
   ...
   public final class Cmd_NewScrewUp_Restart_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_NewScrewUp_Restart_SC";
      
      public static const RESULT:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("PVZ.Cmd.Cmd_NewScrewUp_Restart_SC.result","result",1 << 3 | WireType.VARINT);
      
      public static const RESTARTNUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_NewScrewUp_Restart_SC.restartNum","restartNum",2 << 3 | WireType.VARINT);
      
      public static const VIPRESTARTNUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_NewScrewUp_Restart_SC.vipRestartNum","vipRestartNum",3 << 3 | WireType.VARINT);
      ...
      public function Cmd_NewScrewUp_Restart_SC()
      {
         super();
      }
      ...
      {
         return Cmd_NewScrewUp_Restart_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc6_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_NewScrewUp_Restart_SC.result cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_NewScrewUp_Restart_SC.restartNum cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_NewScrewUp_Restart_SC.vipRestartNum cannot be set twice.");
                  }
                  _loc5_++;
