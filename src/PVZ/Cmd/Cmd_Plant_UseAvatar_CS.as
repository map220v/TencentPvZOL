package PVZ.Cmd
{
   ...
   public final class Cmd_Plant_UseAvatar_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Plant_UseAvatar_CS";
      
      public static const PLANTID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Plant_UseAvatar_CS.plantId","plantId",1 << 3 | WireType.VARINT);
      
      public static const AVATARID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Plant_UseAvatar_CS.avatarId","avatarId",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_Plant_UseAvatar_CS()
      {
         super();
      }
      ...
      {
         return Cmd_Plant_UseAvatar_CS.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Plant_UseAvatar_CS.plantId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Plant_UseAvatar_CS.avatarId cannot be set twice.");
                  }
                  _loc4_++;
