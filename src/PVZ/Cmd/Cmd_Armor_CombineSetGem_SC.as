package PVZ.Cmd
{
   ...
   public final class Cmd_Armor_CombineSetGem_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Armor_CombineSetGem_SC";
      
      public static const CARDUID:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Cmd_Armor_CombineSetGem_SC.cardUId","cardUId",1 << 3 | WireType.VARINT);
      
      public static const ARMORTYPE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Armor_CombineSetGem_SC.armorType","armorType",2 << 3 | WireType.VARINT);
      
      public static const GEMTYPE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Armor_CombineSetGem_SC.gemType","gemType",3 << 3 | WireType.VARINT);
      
      public static const COMBINEITEMID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Armor_CombineSetGem_SC.combineItemId","combineItemId",4 << 3 | WireType.VARINT);
      ...
      public function Cmd_Armor_CombineSetGem_SC()
      {
         super();
      }
      ...
      {
         return Cmd_Armor_CombineSetGem_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc7_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Armor_CombineSetGem_SC.cardUId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Armor_CombineSetGem_SC.armorType cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Armor_CombineSetGem_SC.gemType cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Armor_CombineSetGem_SC.combineItemId cannot be set twice.");
                  }
                  _loc6_++;
