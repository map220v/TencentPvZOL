package PVZ.Cmd
{
   ...
   public final class Dto_Uint32Tracker extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Dto_Uint32Tracker";
      
      public static const EQ:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_Uint32Tracker.eq","eq",1 << 3 | WireType.VARINT);
      
      public static const NE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_Uint32Tracker.ne","ne",2 << 3 | WireType.VARINT);
      
      public static const LT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_Uint32Tracker.lt","lt",3 << 3 | WireType.VARINT);
      
      public static const LE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_Uint32Tracker.le","le",4 << 3 | WireType.VARINT);
      
      public static const GT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_Uint32Tracker.gt","gt",5 << 3 | WireType.VARINT);
      
      public static const GE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_Uint32Tracker.ge","ge",6 << 3 | WireType.VARINT);
      
      public static const VALUE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_Uint32Tracker.value","value",7 << 3 | WireType.VARINT);
      ...
      public function Dto_Uint32Tracker()
      {
         super();
      }
      ...
      {
         return Dto_Uint32Tracker.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc10_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_Uint32Tracker.eq cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_Uint32Tracker.ne cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_Uint32Tracker.lt cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_Uint32Tracker.le cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 5:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_Uint32Tracker.gt cannot be set twice.");
                  }
                  _loc7_++;
               ...
               case 6:
                  if(_loc8_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_Uint32Tracker.ge cannot be set twice.");
                  }
                  _loc8_++;
               ...
               case 7:
                  if(_loc9_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_Uint32Tracker.value cannot be set twice.");
                  }
                  _loc9_++;
