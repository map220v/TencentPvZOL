package PVZ.Cmd
{
   ...
   public final class Cmd_Guild_GetQuickJoin_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Guild_GetQuickJoin_SC";
      
      public static const ALLOWQUICKJOIN:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("PVZ.Cmd.Cmd_Guild_GetQuickJoin_SC.allowQuickJoin","allowQuickJoin",1 << 3 | WireType.VARINT);
      
      public static const NEEDPOWER:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Guild_GetQuickJoin_SC.needPower","needPower",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_Guild_GetQuickJoin_SC()
      {
         super();
      }
      ...
      {
         return Cmd_Guild_GetQuickJoin_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Guild_GetQuickJoin_SC.allowQuickJoin cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Guild_GetQuickJoin_SC.needPower cannot be set twice.");
                  }
                  _loc4_++;
