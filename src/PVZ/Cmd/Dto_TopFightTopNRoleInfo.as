package PVZ.Cmd
{
   ...
   public final class Dto_TopFightTopNRoleInfo extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Dto_TopFightTopNRoleInfo";
      
      public static const ROLEID:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Dto_TopFightTopNRoleInfo.roleId","roleId",1 << 3 | WireType.VARINT);
      
      public static const FIGHTSIDE:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Dto_TopFightTopNRoleInfo.fightSide","fightSide",2 << 3 | WireType.LENGTH_DELIMITED,Dto_FightSideInfo);
      
      public static const CARDFORMATION:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Dto_TopFightTopNRoleInfo.cardFormation","cardFormation",3 << 3 | WireType.LENGTH_DELIMITED,Dto_CardFormation);
      
      public static const POWER:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_TopFightTopNRoleInfo.power","power",4 << 3 | WireType.VARINT);
      
      public static const PUPPETFORMATION:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Dto_TopFightTopNRoleInfo.puppetFormation","puppetFormation",5 << 3 | WireType.LENGTH_DELIMITED,PVZ.Protocol.Dto_PuppetFormation);
      ...
      public function Dto_TopFightTopNRoleInfo()
      {
         super();
      }
      ...
      {
         return Dto_TopFightTopNRoleInfo.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc8_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TopFightTopNRoleInfo.roleId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TopFightTopNRoleInfo.fightSide cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TopFightTopNRoleInfo.cardFormation cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TopFightTopNRoleInfo.power cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 5:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TopFightTopNRoleInfo.puppetFormation cannot be set twice.");
                  }
                  _loc7_++;
