package PVZ.Cmd
{
   ...
   public final class Cmd_NoEndTD_BuyCart_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_NoEndTD_BuyCart_SC";
      
      public static const CARTID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_NoEndTD_BuyCart_SC.cartId","cartId",1 << 3 | WireType.VARINT);
      
      public static const REMAINTIMES:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_NoEndTD_BuyCart_SC.remainTimes","remainTimes",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_NoEndTD_BuyCart_SC()
      {
         super();
      }
      ...
      {
         return Cmd_NoEndTD_BuyCart_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_NoEndTD_BuyCart_SC.cartId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_NoEndTD_BuyCart_SC.remainTimes cannot be set twice.");
                  }
                  _loc4_++;
