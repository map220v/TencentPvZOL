package PVZ.Cmd
{
   ...
   public final class Cmd_Lab_UpgradeLab_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Lab_UpgradeLab_SC";
      
      public static const CHANGELAB:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_Lab_UpgradeLab_SC.changeLab","changeLab",1 << 3 | WireType.LENGTH_DELIMITED,Dto_LabItem);
       
      
      private var changeLab$field:Dto_LabItem;
      
      public function Cmd_Lab_UpgradeLab_SC()
      {
         super();
      }
      ...
      {
         return Cmd_Lab_UpgradeLab_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc4_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Lab_UpgradeLab_SC.changeLab cannot be set twice.");
                  }
                  _loc3_++;
