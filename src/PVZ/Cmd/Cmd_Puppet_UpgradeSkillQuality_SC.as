package PVZ.Cmd
{
   ...
   public final class Cmd_Puppet_UpgradeSkillQuality_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Puppet_UpgradeSkillQuality_SC";
      
      public static const BASEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Puppet_UpgradeSkillQuality_SC.baseId","baseId",1 << 3 | WireType.VARINT);
      
      public static const PASSIVESKILL:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("PVZ.Cmd.Cmd_Puppet_UpgradeSkillQuality_SC.passiveSkill","passiveSkill",2 << 3 | WireType.VARINT);
      
      public static const SKILLID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Puppet_UpgradeSkillQuality_SC.skillId","skillId",3 << 3 | WireType.VARINT);
      ...
      public function Cmd_Puppet_UpgradeSkillQuality_SC()
      {
         super();
      }
      ...
      {
         return Cmd_Puppet_UpgradeSkillQuality_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc6_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Puppet_UpgradeSkillQuality_SC.baseId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Puppet_UpgradeSkillQuality_SC.passiveSkill cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Puppet_UpgradeSkillQuality_SC.skillId cannot be set twice.");
                  }
                  _loc5_++;
