package PVZ.Cmd
{
   ...
   public final class Cmd_SecondPwd_Conditon_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_SecondPwd_Conditon_CS";
      
      public static const SYSTEM:RepeatedFieldDescriptor$TYPE_UINT32 = new RepeatedFieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_SecondPwd_Conditon_CS.system","system",1 << 3 | WireType.VARINT);
       
      
      public var system:Array;
      
      public function Cmd_SecondPwd_Conditon_CS()
      {
         this.system = [];
         super();
      }
      ...
      {
         return Cmd_SecondPwd_Conditon_CS.$MessageID;
      }
