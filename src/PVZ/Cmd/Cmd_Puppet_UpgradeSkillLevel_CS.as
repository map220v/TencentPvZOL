package PVZ.Cmd
{
   ...
   public final class Cmd_Puppet_UpgradeSkillLevel_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Puppet_UpgradeSkillLevel_CS";
      
      public static const BASEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Puppet_UpgradeSkillLevel_CS.baseId","baseId",1 << 3 | WireType.VARINT);
      
      public static const PASSIVESKILL:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("PVZ.Cmd.Cmd_Puppet_UpgradeSkillLevel_CS.passiveSkill","passiveSkill",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_Puppet_UpgradeSkillLevel_CS()
      {
         super();
      }
      ...
      {
         return Cmd_Puppet_UpgradeSkillLevel_CS.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Puppet_UpgradeSkillLevel_CS.baseId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Puppet_UpgradeSkillLevel_CS.passiveSkill cannot be set twice.");
                  }
                  _loc4_++;
