package PVZ.Cmd
{
   ...
   public final class Cmd_ScrewUp_GetInfo_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_ScrewUp_GetInfo_SC";
      
      public static const CURRENTSTAGE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_ScrewUp_GetInfo_SC.currentStage","currentStage",1 << 3 | WireType.VARINT);
      
      public static const MAXSTAGE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_ScrewUp_GetInfo_SC.maxStage","maxStage",2 << 3 | WireType.VARINT);
      
      public static const RESTARTNUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_ScrewUp_GetInfo_SC.restartNum","restartNum",3 << 3 | WireType.VARINT);
      
      public static const BOXTAKEN:RepeatedFieldDescriptor$TYPE_UINT32 = new RepeatedFieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_ScrewUp_GetInfo_SC.boxTaken","boxTaken",4 << 3 | WireType.VARINT);
      
      public static const BOXTOTAL:RepeatedFieldDescriptor$TYPE_UINT32 = new RepeatedFieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_ScrewUp_GetInfo_SC.boxTotal","boxTotal",5 << 3 | WireType.VARINT);
      
      public static const REMAINTIME:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_ScrewUp_GetInfo_SC.remainTime","remainTime",6 << 3 | WireType.VARINT);
      
      public static const VIPRESTARTNUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_ScrewUp_GetInfo_SC.vipRestartNum","vipRestartNum",7 << 3 | WireType.VARINT);
      ...
      public function Cmd_ScrewUp_GetInfo_SC()
      {
         this.boxTaken = [];
         this.boxTotal = [];
         super();
      ...
      {
         return Cmd_ScrewUp_GetInfo_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc8_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ScrewUp_GetInfo_SC.currentStage cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ScrewUp_GetInfo_SC.maxStage cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ScrewUp_GetInfo_SC.restartNum cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 6:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ScrewUp_GetInfo_SC.remainTime cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 7:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ScrewUp_GetInfo_SC.vipRestartNum cannot be set twice.");
                  }
                  _loc7_++;
