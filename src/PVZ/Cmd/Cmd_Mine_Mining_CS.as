package PVZ.Cmd
{
   ...
   public final class Cmd_Mine_Mining_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Mine_Mining_CS";
      
      public static const TARGETPOS:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_Mine_Mining_CS.targetPos","targetPos",1 << 3 | WireType.LENGTH_DELIMITED,Dto_WorldMap_Pos);
       
      
      private var targetPos$field:Dto_WorldMap_Pos;
      
      public function Cmd_Mine_Mining_CS()
      {
         super();
      }
      ...
      {
         return Cmd_Mine_Mining_CS.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc4_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Mine_Mining_CS.targetPos cannot be set twice.");
                  }
                  _loc3_++;
