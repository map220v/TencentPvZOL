package PVZ.Cmd
{
   ...
   public final class Cmd_DoIdipGm_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_DoIdipGm_SC";
      
      public static const RESPONSECMD:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("PVZ.Cmd.Cmd_DoIdipGm_SC.responseCmd","responseCmd",1 << 3 | WireType.LENGTH_DELIMITED);
       
      
      private var responseCmd$field:String;
      
      public function Cmd_DoIdipGm_SC()
      {
         super();
      }
      ...
      {
         return Cmd_DoIdipGm_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc4_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_DoIdipGm_SC.responseCmd cannot be set twice.");
                  }
                  _loc3_++;
