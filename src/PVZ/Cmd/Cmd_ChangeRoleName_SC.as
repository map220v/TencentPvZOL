package PVZ.Cmd
{
   ...
   public final class Cmd_ChangeRoleName_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_ChangeRoleName_SC";
      
      public static const ROLENAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("PVZ.Cmd.Cmd_ChangeRoleName_SC.roleName","roleName",1 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const SEX:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("PVZ.Cmd.Cmd_ChangeRoleName_SC.sex","sex",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_ChangeRoleName_SC()
      {
         super();
      }
      ...
      {
         return Cmd_ChangeRoleName_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ChangeRoleName_SC.roleName cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ChangeRoleName_SC.sex cannot be set twice.");
                  }
                  _loc4_++;
