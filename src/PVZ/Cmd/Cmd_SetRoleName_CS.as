package PVZ.Cmd
{
   ...
   public final class Cmd_SetRoleName_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_SetRoleName_CS";
      
      public static const ROLENAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("PVZ.Cmd.Cmd_SetRoleName_CS.roleName","roleName",1 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const SEX:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("PVZ.Cmd.Cmd_SetRoleName_CS.sex","sex",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_SetRoleName_CS()
      {
         super();
      }
      ...
      {
         return Cmd_SetRoleName_CS.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_SetRoleName_CS.roleName cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_SetRoleName_CS.sex cannot be set twice.");
                  }
                  _loc4_++;
