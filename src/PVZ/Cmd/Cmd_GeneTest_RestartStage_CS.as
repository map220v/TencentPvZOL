package PVZ.Cmd
{
   ...
   public final class Cmd_GeneTest_RestartStage_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_GeneTest_RestartStage_CS";
      
      public static const STAGEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_GeneTest_RestartStage_CS.stageId","stageId",1 << 3 | WireType.VARINT);
      
      public static const STAGEMODE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_GeneTest_RestartStage_CS.stageMode","stageMode",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_GeneTest_RestartStage_CS()
      {
         super();
      }
      ...
      {
         return Cmd_GeneTest_RestartStage_CS.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_GeneTest_RestartStage_CS.stageId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_GeneTest_RestartStage_CS.stageMode cannot be set twice.");
                  }
                  _loc4_++;
