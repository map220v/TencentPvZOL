package PVZ.Cmd
{
   ...
   public final class Cmd_Card_Refine_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Card_Refine_SC";
      
      public static const CARDUID:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Cmd_Card_Refine_SC.cardUId","cardUId",1 << 3 | WireType.VARINT);
      
      public static const MODE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Card_Refine_SC.mode","mode",2 << 3 | WireType.VARINT);
      
      public static const ATTRIBUTE:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_Card_Refine_SC.attribute","attribute",3 << 3 | WireType.LENGTH_DELIMITED,Dto_RefineAttribute);
      
      public static const SPEED:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Card_Refine_SC.speed","speed",4 << 3 | WireType.VARINT);
      ...
      public function Cmd_Card_Refine_SC()
      {
         this.attribute = [];
         super();
      }
      ...
      {
         return Cmd_Card_Refine_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc6_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Card_Refine_SC.cardUId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Card_Refine_SC.mode cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 4:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Card_Refine_SC.speed cannot be set twice.");
                  }
                  _loc5_++;
