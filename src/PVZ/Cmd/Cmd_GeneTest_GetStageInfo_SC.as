package PVZ.Cmd
{
   ...
   public final class Cmd_GeneTest_GetStageInfo_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_GeneTest_GetStageInfo_SC";
      
      public static const STAGEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_GeneTest_GetStageInfo_SC.stageId","stageId",1 << 3 | WireType.VARINT);
      
      public static const CURRENTSUBCHAPTERID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_GeneTest_GetStageInfo_SC.currentSubChapterId","currentSubChapterId",2 << 3 | WireType.VARINT);
      
      public static const MAXSUBCHAPTERID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_GeneTest_GetStageInfo_SC.maxSubChapterId","maxSubChapterId",3 << 3 | WireType.VARINT);
      
      public static const REMAINTIMES:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_GeneTest_GetStageInfo_SC.remainTimes","remainTimes",4 << 3 | WireType.VARINT);
      
      public static const REWARDLIST:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_GeneTest_GetStageInfo_SC.rewardList","rewardList",5 << 3 | WireType.LENGTH_DELIMITED,Dto_IdNum);
      
      public static const SHOWCARD:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_GeneTest_GetStageInfo_SC.showCard","showCard",6 << 3 | WireType.LENGTH_DELIMITED,Dto_CardBaseInfo);
      
      public static const DEFENSEROLENAME:RepeatedFieldDescriptor$TYPE_STRING = new RepeatedFieldDescriptor$TYPE_STRING("PVZ.Cmd.Cmd_GeneTest_GetStageInfo_SC.defenseRoleName","defenseRoleName",7 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const STAGEMODE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_GeneTest_GetStageInfo_SC.stageMode","stageMode",8 << 3 | WireType.VARINT);
      ...
      public function Cmd_GeneTest_GetStageInfo_SC()
      {
         this.rewardList = [];
         this.showCard = [];
      ...
      {
         return Cmd_GeneTest_GetStageInfo_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc8_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_GeneTest_GetStageInfo_SC.stageId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_GeneTest_GetStageInfo_SC.currentSubChapterId cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_GeneTest_GetStageInfo_SC.maxSubChapterId cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_GeneTest_GetStageInfo_SC.remainTimes cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 8:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_GeneTest_GetStageInfo_SC.stageMode cannot be set twice.");
                  }
                  _loc7_++;
