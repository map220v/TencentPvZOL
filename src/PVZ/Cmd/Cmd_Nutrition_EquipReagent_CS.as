package PVZ.Cmd
{
   ...
   public final class Cmd_Nutrition_EquipReagent_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Nutrition_EquipReagent_CS";
      
      public static const REAGENTUID:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Cmd_Nutrition_EquipReagent_CS.reagentUID","reagentUID",1 << 3 | WireType.VARINT);
      
      public static const POSITION:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Nutrition_EquipReagent_CS.position","position",2 << 3 | WireType.VARINT);
      
      public static const SLOTID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Nutrition_EquipReagent_CS.slotId","slotId",3 << 3 | WireType.VARINT);
      ...
      public function Cmd_Nutrition_EquipReagent_CS()
      {
         super();
      }
      ...
      {
         return Cmd_Nutrition_EquipReagent_CS.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc6_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Nutrition_EquipReagent_CS.reagentUID cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Nutrition_EquipReagent_CS.position cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Nutrition_EquipReagent_CS.slotId cannot be set twice.");
                  }
                  _loc5_++;
