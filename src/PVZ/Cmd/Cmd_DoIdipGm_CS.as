package PVZ.Cmd
{
   ...
   public final class Cmd_DoIdipGm_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_DoIdipGm_CS";
      
      public static const REQUESTCMD:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("PVZ.Cmd.Cmd_DoIdipGm_CS.requestCmd","requestCmd",1 << 3 | WireType.LENGTH_DELIMITED);
       
      
      private var requestCmd$field:String;
      
      public function Cmd_DoIdipGm_CS()
      {
         super();
      }
      ...
      {
         return Cmd_DoIdipGm_CS.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc4_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_DoIdipGm_CS.requestCmd cannot be set twice.");
                  }
                  _loc3_++;
