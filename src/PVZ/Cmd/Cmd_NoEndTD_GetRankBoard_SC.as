package PVZ.Cmd
{
   ...
   public final class Cmd_NoEndTD_GetRankBoard_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_NoEndTD_GetRankBoard_SC";
      
      public static const MODE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_NoEndTD_GetRankBoard_SC.mode","mode",1 << 3 | WireType.VARINT);
      
      public static const PAGENO:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_NoEndTD_GetRankBoard_SC.pageNo","pageNo",2 << 3 | WireType.VARINT);
      
      public static const TOTALPAGENUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_NoEndTD_GetRankBoard_SC.totalPageNum","totalPageNum",3 << 3 | WireType.VARINT);
      
      public static const RECORDER:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_NoEndTD_GetRankBoard_SC.recorder","recorder",4 << 3 | WireType.LENGTH_DELIMITED,Dto_NoEndTD_RankRecorder);
      
      public static const MYRECORDER:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_NoEndTD_GetRankBoard_SC.myRecorder","myRecorder",5 << 3 | WireType.LENGTH_DELIMITED,Dto_NoEndTD_RankRecorder);
      
      public static const MYRANK:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_NoEndTD_GetRankBoard_SC.myRank","myRank",6 << 3 | WireType.VARINT);
      ...
      public function Cmd_NoEndTD_GetRankBoard_SC()
      {
         this.recorder = [];
         super();
      }
      ...
      {
         return Cmd_NoEndTD_GetRankBoard_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc8_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_NoEndTD_GetRankBoard_SC.mode cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_NoEndTD_GetRankBoard_SC.pageNo cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_NoEndTD_GetRankBoard_SC.totalPageNum cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 5:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_NoEndTD_GetRankBoard_SC.myRecorder cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 6:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_NoEndTD_GetRankBoard_SC.myRank cannot be set twice.");
                  }
                  _loc7_++;
