package PVZ.Cmd
{
   ...
   public final class Cmd_SuperFlopCard_FlopCard_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_SuperFlopCard_FlopCard_SC";
      
      public static const LUCK:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_SuperFlopCard_FlopCard_SC.luck","luck",1 << 3 | WireType.VARINT);
      
      public static const SUPLUSTIMES:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_SuperFlopCard_FlopCard_SC.suplusTimes","suplusTimes",2 << 3 | WireType.VARINT);
      
      public static const CARDINFO:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_SuperFlopCard_FlopCard_SC.cardInfo","cardInfo",3 << 3 | WireType.LENGTH_DELIMITED,Dto_CardInfo);
      
      public static const BUYTIMESPRICE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_SuperFlopCard_FlopCard_SC.buyTimesPrice","buyTimesPrice",4 << 3 | WireType.VARINT);
      
      public static const SUPLUSBUYTIMES:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_SuperFlopCard_FlopCard_SC.suplusBuyTimes","suplusBuyTimes",5 << 3 | WireType.VARINT);
      
      public static const CURMULTIPLE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_SuperFlopCard_FlopCard_SC.curMultiple","curMultiple",6 << 3 | WireType.VARINT);
      ...
      public function Cmd_SuperFlopCard_FlopCard_SC()
      {
         this.cardInfo = [];
         super();
      }
      ...
      {
         return Cmd_SuperFlopCard_FlopCard_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc8_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_SuperFlopCard_FlopCard_SC.luck cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_SuperFlopCard_FlopCard_SC.suplusTimes cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 4:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_SuperFlopCard_FlopCard_SC.buyTimesPrice cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 5:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_SuperFlopCard_FlopCard_SC.suplusBuyTimes cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 6:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_SuperFlopCard_FlopCard_SC.curMultiple cannot be set twice.");
                  }
                  _loc7_++;
