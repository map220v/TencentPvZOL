package PVZ.Cmd
{
   ...
   public final class Cmd_ExpeditionFight_Attack_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_ExpeditionFight_Attack_CS";
      
      public static const SIDEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_ExpeditionFight_Attack_CS.sideId","sideId",1 << 3 | WireType.VARINT);
      
      public static const CITYID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_ExpeditionFight_Attack_CS.cityId","cityId",2 << 3 | WireType.VARINT);
      
      public static const BUYCOUNT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_ExpeditionFight_Attack_CS.buyCount","buyCount",3 << 3 | WireType.VARINT);
      ...
      public function Cmd_ExpeditionFight_Attack_CS()
      {
         super();
      }
      ...
      {
         return Cmd_ExpeditionFight_Attack_CS.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc6_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ExpeditionFight_Attack_CS.sideId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ExpeditionFight_Attack_CS.cityId cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ExpeditionFight_Attack_CS.buyCount cannot be set twice.");
                  }
                  _loc5_++;
