package PVZ.Cmd
{
   ...
   public final class Cmd_Card_BatchFill_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Card_BatchFill_SC";
      
      public static const CARDUID:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Cmd_Card_BatchFill_SC.cardUId","cardUId",1 << 3 | WireType.VARINT);
      
      public static const PIECEINDEXLIST:RepeatedFieldDescriptor$TYPE_UINT32 = new RepeatedFieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Card_BatchFill_SC.pieceIndexList","pieceIndexList",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_Card_BatchFill_SC()
      {
         this.pieceIndexList = [];
         super();
      }
      ...
      {
         return Cmd_Card_BatchFill_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc4_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Card_BatchFill_SC.cardUId cannot be set twice.");
                  }
                  _loc3_++;
