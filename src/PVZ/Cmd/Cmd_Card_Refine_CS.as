package PVZ.Cmd
{
   ...
   public final class Cmd_Card_Refine_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Card_Refine_CS";
      
      public static const CARDUID:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Cmd_Card_Refine_CS.cardUId","cardUId",1 << 3 | WireType.VARINT);
      
      public static const MODE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Card_Refine_CS.mode","mode",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_Card_Refine_CS()
      {
         super();
      }
      ...
      {
         return Cmd_Card_Refine_CS.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Card_Refine_CS.cardUId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Card_Refine_CS.mode cannot be set twice.");
                  }
                  _loc4_++;
