package PVZ.Cmd
{
   ...
   public final class Dto_TopFightPairRoleInfo extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Dto_TopFightPairRoleInfo";
      
      public static const ROLEID:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Dto_TopFightPairRoleInfo.roleId","roleId",1 << 3 | WireType.VARINT);
      
      public static const ZONEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_TopFightPairRoleInfo.zoneId","zoneId",2 << 3 | WireType.VARINT);
      
      public static const UIN:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_TopFightPairRoleInfo.uin","uin",3 << 3 | WireType.VARINT);
      
      public static const LEVEL:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_TopFightPairRoleInfo.level","level",4 << 3 | WireType.VARINT);
      
      public static const ROLENAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("PVZ.Cmd.Dto_TopFightPairRoleInfo.roleName","roleName",5 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const QQFACEURL:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("PVZ.Cmd.Dto_TopFightPairRoleInfo.qqFaceURL","qqFaceURL",6 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const POWER:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_TopFightPairRoleInfo.power","power",7 << 3 | WireType.VARINT);
      
      public static const BETODDS:FieldDescriptor$TYPE_FLOAT = new FieldDescriptor$TYPE_FLOAT("PVZ.Cmd.Dto_TopFightPairRoleInfo.betOdds","betOdds",8 << 3 | WireType.FIXED_32_BIT);
      ...
      public function Dto_TopFightPairRoleInfo()
      {
         super();
      }
      ...
      {
         return Dto_TopFightPairRoleInfo.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc11_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TopFightPairRoleInfo.roleId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TopFightPairRoleInfo.zoneId cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TopFightPairRoleInfo.uin cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TopFightPairRoleInfo.level cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 5:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TopFightPairRoleInfo.roleName cannot be set twice.");
                  }
                  _loc7_++;
               ...
               case 6:
                  if(_loc8_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TopFightPairRoleInfo.qqFaceURL cannot be set twice.");
                  }
                  _loc8_++;
               ...
               case 7:
                  if(_loc9_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TopFightPairRoleInfo.power cannot be set twice.");
                  }
                  _loc9_++;
               ...
               case 8:
                  if(_loc10_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_TopFightPairRoleInfo.betOdds cannot be set twice.");
                  }
                  _loc10_++;
