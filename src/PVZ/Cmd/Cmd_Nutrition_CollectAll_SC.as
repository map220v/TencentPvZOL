package PVZ.Cmd
{
   ...
   public final class Cmd_Nutrition_CollectAll_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Nutrition_CollectAll_SC";
      
      public static const GOLDREAGENTNUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Nutrition_CollectAll_SC.goldReagentNum","goldReagentNum",1 << 3 | WireType.VARINT);
      
      public static const REMAINREAGENT:RepeatedFieldDescriptor$TYPE_UINT32 = new RepeatedFieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Nutrition_CollectAll_SC.remainReagent","remainReagent",2 << 3 | WireType.VARINT);
      
      public static const STOPREASON:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("PVZ.Cmd.Cmd_Nutrition_CollectAll_SC.stopReason","stopReason",3 << 3 | WireType.VARINT);
      ...
      public function Cmd_Nutrition_CollectAll_SC()
      {
         this.remainReagent = [];
         super();
      }
      ...
      {
         return Cmd_Nutrition_CollectAll_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Nutrition_CollectAll_SC.goldReagentNum cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 3:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Nutrition_CollectAll_SC.stopReason cannot be set twice.");
                  }
                  _loc4_++;
