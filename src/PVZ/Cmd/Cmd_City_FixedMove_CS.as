package PVZ.Cmd
{
   ...
   public final class Cmd_City_FixedMove_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_City_FixedMove_CS";
      
      public static const AREA:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("PVZ.Cmd.Cmd_City_FixedMove_CS.area","area",1 << 3 | WireType.VARINT);
      
      public static const NEWPOS:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_City_FixedMove_CS.newPos","newPos",2 << 3 | WireType.LENGTH_DELIMITED,Dto_WorldMap_Pos);
      ...
      public function Cmd_City_FixedMove_CS()
      {
         super();
      }
      ...
      {
         return Cmd_City_FixedMove_CS.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_City_FixedMove_CS.area cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_City_FixedMove_CS.newPos cannot be set twice.");
                  }
                  _loc4_++;
