package PVZ.Cmd
{
   ...
   public final class Cmd_ScrewUp_Fight_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_ScrewUp_Fight_SC";
      
      public static const STAGEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_ScrewUp_Fight_SC.stageId","stageId",1 << 3 | WireType.VARINT);
      
      public static const ISSWEEP:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("PVZ.Cmd.Cmd_ScrewUp_Fight_SC.isSweep","isSweep",2 << 3 | WireType.VARINT);
      
      public static const REPORT:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_ScrewUp_Fight_SC.report","report",3 << 3 | WireType.LENGTH_DELIMITED,Dto_FightReport);
      
      public static const FIRSTPASS:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("PVZ.Cmd.Cmd_ScrewUp_Fight_SC.firstPass","firstPass",4 << 3 | WireType.VARINT);
      
      public static const WIN:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("PVZ.Cmd.Cmd_ScrewUp_Fight_SC.win","win",5 << 3 | WireType.VARINT);
      
      public static const REWARDLIST:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_ScrewUp_Fight_SC.rewardList","rewardList",6 << 3 | WireType.LENGTH_DELIMITED,Dto_IdNum);
      ...
      public function Cmd_ScrewUp_Fight_SC()
      {
         this.rewardList = [];
         super();
      }
      ...
      {
         return Cmd_ScrewUp_Fight_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc8_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ScrewUp_Fight_SC.stageId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ScrewUp_Fight_SC.isSweep cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ScrewUp_Fight_SC.report cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ScrewUp_Fight_SC.firstPass cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 5:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ScrewUp_Fight_SC.win cannot be set twice.");
                  }
                  _loc7_++;
