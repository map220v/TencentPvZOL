package PVZ.Cmd
{
   ...
   public final class Cmd_Shelling_GetInfo_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Shelling_GetInfo_SC";
      
      public static const TOTALTICKET:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Shelling_GetInfo_SC.totalTicket","totalTicket",1 << 3 | WireType.VARINT);
      
      public static const TICKET:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Shelling_GetInfo_SC.ticket","ticket",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_Shelling_GetInfo_SC()
      {
         super();
      }
      ...
      {
         return Cmd_Shelling_GetInfo_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Shelling_GetInfo_SC.totalTicket cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Shelling_GetInfo_SC.ticket cannot be set twice.");
                  }
                  _loc4_++;
