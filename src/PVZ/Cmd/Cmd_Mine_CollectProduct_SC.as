package PVZ.Cmd
{
   ...
   public final class Cmd_Mine_CollectProduct_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Mine_CollectProduct_SC";
      
      public static const TARGETPOS:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_Mine_CollectProduct_SC.targetPos","targetPos",1 << 3 | WireType.LENGTH_DELIMITED,Dto_WorldMap_Pos);
      
      public static const COIN:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Mine_CollectProduct_SC.coin","coin",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_Mine_CollectProduct_SC()
      {
         super();
      }
      ...
      {
         return Cmd_Mine_CollectProduct_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Mine_CollectProduct_SC.targetPos cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Mine_CollectProduct_SC.coin cannot be set twice.");
                  }
                  _loc4_++;
