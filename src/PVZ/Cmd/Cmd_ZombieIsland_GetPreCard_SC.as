package PVZ.Cmd
{
   ...
   public final class Cmd_ZombieIsland_GetPreCard_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_ZombieIsland_GetPreCard_SC";
      
      public static const CARDLIST:RepeatedFieldDescriptor$TYPE_INT64 = new RepeatedFieldDescriptor$TYPE_INT64("PVZ.Cmd.Cmd_ZombieIsland_GetPreCard_SC.cardList","cardList",1 << 3 | WireType.VARINT);
      
      public static const HASSET:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("PVZ.Cmd.Cmd_ZombieIsland_GetPreCard_SC.hasSet","hasSet",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_ZombieIsland_GetPreCard_SC()
      {
         this.cardList = [];
         super();
      }
      ...
      {
         return Cmd_ZombieIsland_GetPreCard_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc4_ >> 3)
            {
               ...
               case 2:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ZombieIsland_GetPreCard_SC.hasSet cannot be set twice.");
                  }
                  _loc3_++;
