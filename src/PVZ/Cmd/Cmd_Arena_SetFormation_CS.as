package PVZ.Cmd
{
   ...
   public final class Cmd_Arena_SetFormation_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Arena_SetFormation_CS";
      
      public static const FORMATION:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_Arena_SetFormation_CS.formation","formation",1 << 3 | WireType.LENGTH_DELIMITED,Dto_FormationInfo);
       
      
      private var formation$field:Dto_FormationInfo;
      
      public function Cmd_Arena_SetFormation_CS()
      {
         super();
      }
      ...
      {
         return Cmd_Arena_SetFormation_CS.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc4_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Arena_SetFormation_CS.formation cannot be set twice.");
                  }
                  _loc3_++;
