package PVZ.Cmd
{
   ...
   public final class Cmd_Garden_Water_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Garden_Water_SC";
      
      public static const FIELDID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Garden_Water_SC.fieldid","fieldid",1 << 3 | WireType.VARINT);
      
      public static const FIELD:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_Garden_Water_SC.field","field",2 << 3 | WireType.LENGTH_DELIMITED,Dto_Field);
      ...
      public function Cmd_Garden_Water_SC()
      {
         super();
      }
      ...
      {
         return Cmd_Garden_Water_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Garden_Water_SC.fieldid cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Garden_Water_SC.field cannot be set twice.");
                  }
                  _loc4_++;
