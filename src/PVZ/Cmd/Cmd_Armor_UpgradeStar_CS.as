package PVZ.Cmd
{
   ...
   public final class Cmd_Armor_UpgradeStar_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Armor_UpgradeStar_CS";
      
      public static const CARDUID:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Cmd_Armor_UpgradeStar_CS.cardUId","cardUId",1 << 3 | WireType.VARINT);
      
      public static const ARMORTYPE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Armor_UpgradeStar_CS.armorType","armorType",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_Armor_UpgradeStar_CS()
      {
         super();
      }
      ...
      {
         return Cmd_Armor_UpgradeStar_CS.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Armor_UpgradeStar_CS.cardUId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Armor_UpgradeStar_CS.armorType cannot be set twice.");
                  }
                  _loc4_++;
