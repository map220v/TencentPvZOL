package PVZ.Cmd
{
   ...
   public final class Cmd_FlexibleActivity_GrowFundBaseInfo_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_FlexibleActivity_GrowFundBaseInfo_SC";
      
      public static const ACTIVITYID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_FlexibleActivity_GrowFundBaseInfo_SC.activityId","activityId",1 << 3 | WireType.VARINT);
      
      public static const CANBUYDAY:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_FlexibleActivity_GrowFundBaseInfo_SC.canBuyDay","canBuyDay",2 << 3 | WireType.VARINT);
      
      public static const OPENBUY:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_FlexibleActivity_GrowFundBaseInfo_SC.openBuy","openBuy",3 << 3 | WireType.VARINT);
      
      public static const PRICE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_FlexibleActivity_GrowFundBaseInfo_SC.price","price",4 << 3 | WireType.VARINT);
      
      public static const TOTALVALUE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_FlexibleActivity_GrowFundBaseInfo_SC.totalValue","totalValue",5 << 3 | WireType.VARINT);
      
      public static const BUYTIME:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_FlexibleActivity_GrowFundBaseInfo_SC.buyTime","buyTime",10 << 3 | WireType.VARINT);
      
      public static const GETLIST:RepeatedFieldDescriptor$TYPE_UINT32 = new RepeatedFieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_FlexibleActivity_GrowFundBaseInfo_SC.getList","getList",11 << 3 | WireType.VARINT);
      ...
      public function Cmd_FlexibleActivity_GrowFundBaseInfo_SC()
      {
         this.getList = [];
         super();
      }
      ...
      {
         return Cmd_FlexibleActivity_GrowFundBaseInfo_SC.$MessageID;
      }
      ...
      override public final function writeToBuffer(param1:WritingBuffer) : void
      {
         ...
         while(_loc2_ < this.getList.length)
         {
            ...
            WriteUtils.write$TYPE_UINT32(param1,this.getList[_loc2_]);
            _loc2_++;
         }
         for(_loc3_ in this)
         {
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc9_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_FlexibleActivity_GrowFundBaseInfo_SC.activityId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_FlexibleActivity_GrowFundBaseInfo_SC.canBuyDay cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_FlexibleActivity_GrowFundBaseInfo_SC.openBuy cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_FlexibleActivity_GrowFundBaseInfo_SC.price cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 5:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_FlexibleActivity_GrowFundBaseInfo_SC.totalValue cannot be set twice.");
                  }
                  _loc7_++;
               ...
               case 10:
                  if(_loc8_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_FlexibleActivity_GrowFundBaseInfo_SC.buyTime cannot be set twice.");
                  }
                  _loc8_++;
