package PVZ.Cmd
{
   ...
   public final class Cmd_ZombieIsland_Fight_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_ZombieIsland_Fight_SC";
      
      public static const LEVELID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_ZombieIsland_Fight_SC.levelId","levelId",1 << 3 | WireType.VARINT);
      
      public static const REPORT:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_ZombieIsland_Fight_SC.report","report",2 << 3 | WireType.LENGTH_DELIMITED,Dto_FightReport);
      ...
      public function Cmd_ZombieIsland_Fight_SC()
      {
         super();
      }
      ...
      {
         return Cmd_ZombieIsland_Fight_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ZombieIsland_Fight_SC.levelId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_ZombieIsland_Fight_SC.report cannot be set twice.");
                  }
                  _loc4_++;
