package PVZ.Cmd
{
   ...
   public final class Cmd_Nutrition_Change_CS extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Nutrition_Change_CS";
      
      public static const BASEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Nutrition_Change_CS.baseId","baseId",1 << 3 | WireType.VARINT);
      
      public static const BAGINDEX:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Nutrition_Change_CS.bagIndex","bagIndex",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_Nutrition_Change_CS()
      {
         super();
      }
      ...
      {
         return Cmd_Nutrition_Change_CS.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Nutrition_Change_CS.baseId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Nutrition_Change_CS.bagIndex cannot be set twice.");
                  }
                  _loc4_++;
