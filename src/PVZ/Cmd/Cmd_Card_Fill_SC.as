package PVZ.Cmd
{
   ...
   public final class Cmd_Card_Fill_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Card_Fill_SC";
      
      public static const CARDUID:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Cmd_Card_Fill_SC.cardUId","cardUId",1 << 3 | WireType.VARINT);
      
      public static const PIECEINDEX:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Card_Fill_SC.pieceIndex","pieceIndex",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_Card_Fill_SC()
      {
         super();
      }
      ...
      {
         return Cmd_Card_Fill_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Card_Fill_SC.cardUId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Card_Fill_SC.pieceIndex cannot be set twice.");
                  }
                  _loc4_++;
