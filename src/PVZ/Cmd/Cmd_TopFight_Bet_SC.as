package PVZ.Cmd
{
   ...
   public final class Cmd_TopFight_Bet_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_TopFight_Bet_SC";
      
      public static const STAGEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_TopFight_Bet_SC.stageId","stageId",1 << 3 | WireType.VARINT);
      
      public static const PAIRINDEX:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_TopFight_Bet_SC.pairIndex","pairIndex",2 << 3 | WireType.VARINT);
      
      public static const BETTYPE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_TopFight_Bet_SC.betType","betType",3 << 3 | WireType.VARINT);
      
      public static const BETVALUE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_TopFight_Bet_SC.betValue","betValue",4 << 3 | WireType.VARINT);
      
      public static const BETFIGHTRESULT:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("PVZ.Cmd.Cmd_TopFight_Bet_SC.betFightResult","betFightResult",5 << 3 | WireType.VARINT);
      ...
      public function Cmd_TopFight_Bet_SC()
      {
         super();
      }
      ...
      {
         return Cmd_TopFight_Bet_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc8_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_TopFight_Bet_SC.stageId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_TopFight_Bet_SC.pairIndex cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_TopFight_Bet_SC.betType cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_TopFight_Bet_SC.betValue cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 5:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_TopFight_Bet_SC.betFightResult cannot be set twice.");
                  }
                  _loc7_++;
