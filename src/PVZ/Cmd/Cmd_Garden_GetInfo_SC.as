package PVZ.Cmd
{
   ...
   public final class Cmd_Garden_GetInfo_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Garden_GetInfo_SC";
      
      public static const FIELDS:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_Garden_GetInfo_SC.fields","fields",1 << 3 | WireType.LENGTH_DELIMITED,Dto_Field);
      
      public static const EXP:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Garden_GetInfo_SC.exp","exp",2 << 3 | WireType.VARINT);
      
      public static const BEAN:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Garden_GetInfo_SC.bean","bean",3 << 3 | WireType.VARINT);
      
      public static const PETS:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_Garden_GetInfo_SC.pets","pets",4 << 3 | WireType.LENGTH_DELIMITED,Dto_Pet);
      
      public static const AUTOFERTILIZER:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Garden_GetInfo_SC.autofertilizer","autofertilizer",5 << 3 | WireType.VARINT);
      
      public static const AUTOUSE:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("PVZ.Cmd.Cmd_Garden_GetInfo_SC.autouse","autouse",6 << 3 | WireType.VARINT);
      
      public static const KETTLELIMIT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Garden_GetInfo_SC.kettlelimit","kettlelimit",7 << 3 | WireType.VARINT);
      
      public static const PETEXP:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Garden_GetInfo_SC.petExp","petExp",8 << 3 | WireType.VARINT);
      ...
      public function Cmd_Garden_GetInfo_SC()
      {
         this.fields = [];
         this.pets = [];
         super();
      ...
      {
         return Cmd_Garden_GetInfo_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc9_ >> 3)
            {
               ...
               case 2:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Garden_GetInfo_SC.exp cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 3:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Garden_GetInfo_SC.bean cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 5:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Garden_GetInfo_SC.autofertilizer cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 6:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Garden_GetInfo_SC.autouse cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 7:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Garden_GetInfo_SC.kettlelimit cannot be set twice.");
                  }
                  _loc7_++;
               ...
               case 8:
                  if(_loc8_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Garden_GetInfo_SC.petExp cannot be set twice.");
                  }
                  _loc8_++;
