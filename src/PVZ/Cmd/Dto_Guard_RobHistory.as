package PVZ.Cmd
{
   ...
   public final class Dto_Guard_RobHistory extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Dto_Guard_RobHistory";
      
      public static const NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("PVZ.Cmd.Dto_Guard_RobHistory.name","name",1 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const ZONEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_Guard_RobHistory.zoneId","zoneId",2 << 3 | WireType.VARINT);
      
      public static const LEVEL:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_Guard_RobHistory.level","level",3 << 3 | WireType.VARINT);
      
      public static const FACEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_Guard_RobHistory.faceId","faceId",4 << 3 | WireType.VARINT);
      
      public static const QQFACEURL:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("PVZ.Cmd.Dto_Guard_RobHistory.qqFaceURL","qqFaceURL",5 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const TIME:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Dto_Guard_RobHistory.time","time",6 << 3 | WireType.VARINT);
      
      public static const ROBWIN:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("PVZ.Cmd.Dto_Guard_RobHistory.robWin","robWin",7 << 3 | WireType.VARINT);
      ...
      public function Dto_Guard_RobHistory()
      {
         super();
      }
      ...
      {
         return Dto_Guard_RobHistory.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc10_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_Guard_RobHistory.name cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_Guard_RobHistory.zoneId cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_Guard_RobHistory.level cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_Guard_RobHistory.faceId cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 5:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_Guard_RobHistory.qqFaceURL cannot be set twice.");
                  }
                  _loc7_++;
               ...
               case 6:
                  if(_loc8_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_Guard_RobHistory.time cannot be set twice.");
                  }
                  _loc8_++;
               ...
               case 7:
                  if(_loc9_ != 0)
                  {
                     throw new IOError("Bad data format: Dto_Guard_RobHistory.robWin cannot be set twice.");
                  }
                  _loc9_++;
