package PVZ.Cmd
{
   ...
   public final class Cmd_WorldBoss_FightInfo_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_WorldBoss_FightInfo_SC";
      
      public static const FORMATION:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_WorldBoss_FightInfo_SC.formation","formation",1 << 3 | WireType.LENGTH_DELIMITED,Dto_FormationInfo);
      
      public static const ENEMYCARD:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_WorldBoss_FightInfo_SC.enemyCard","enemyCard",2 << 3 | WireType.LENGTH_DELIMITED,Dto_EnemyCardInfo);
      
      public static const ENEMYTOTALPOWER:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_WorldBoss_FightInfo_SC.enemyTotalPower","enemyTotalPower",3 << 3 | WireType.VARINT);
      ...
      public function Cmd_WorldBoss_FightInfo_SC()
      {
         this.enemyCard = [];
         super();
      }
      ...
      {
         return Cmd_WorldBoss_FightInfo_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_WorldBoss_FightInfo_SC.formation cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 3:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_WorldBoss_FightInfo_SC.enemyTotalPower cannot be set twice.");
                  }
                  _loc4_++;
