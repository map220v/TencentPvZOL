package PVZ.Cmd
{
   ...
   public final class Cmd_Nutrition_Merge_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Nutrition_Merge_SC";
      
      public static const REAGENT:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_Nutrition_Merge_SC.reagent","reagent",1 << 3 | WireType.LENGTH_DELIMITED,Dto_Reagent);
      
      public static const BOTTLEEXP:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Nutrition_Merge_SC.bottleExp","bottleExp",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_Nutrition_Merge_SC()
      {
         super();
      }
      ...
      {
         return Cmd_Nutrition_Merge_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Nutrition_Merge_SC.reagent cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Nutrition_Merge_SC.bottleExp cannot be set twice.");
                  }
                  _loc4_++;
