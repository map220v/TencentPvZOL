package PVZ.Cmd
{
   ...
   public final class Cmd_GuildInfo_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_GuildInfo_SC";
      
      public static const GUILDINFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_GuildInfo_SC.guildInfo","guildInfo",1 << 3 | WireType.LENGTH_DELIMITED,Dto_Guild_Info);
       
      
      private var guildInfo$field:Dto_Guild_Info;
      
      public function Cmd_GuildInfo_SC()
      {
         super();
      }
      ...
      {
         return Cmd_GuildInfo_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc4_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_GuildInfo_SC.guildInfo cannot be set twice.");
                  }
                  _loc3_++;
