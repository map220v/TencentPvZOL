package PVZ.Cmd
{
   ...
   public final class Dto_CardAttributeTerm extends Message
   {
      ...
      public static const $MessageID:String = "PVZ.Cmd.Dto_CardAttributeTerm";
      
      public static const ATTACK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("PVZ.Cmd.Dto_CardAttributeTerm.attack","attack",1 << 3 | WireType.VARINT);
      
      public static const DEFENSE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("PVZ.Cmd.Dto_CardAttributeTerm.defense","defense",2 << 3 | WireType.VARINT);
      
      public static const HP:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Dto_CardAttributeTerm.hp","hp",3 << 3 | WireType.VARINT);
      
      public static const SHIELD:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Dto_CardAttributeTerm.shield","shield",4 << 3 | WireType.VARINT);
      
      public static const ABILITY:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("PVZ.Cmd.Dto_CardAttributeTerm.ability","ability",5 << 3 | WireType.VARINT);
      
      public static const HIT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("PVZ.Cmd.Dto_CardAttributeTerm.hit","hit",6 << 3 | WireType.VARINT);
      
      public static const DODGE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("PVZ.Cmd.Dto_CardAttributeTerm.dodge","dodge",7 << 3 | WireType.VARINT);
      
      public static const CRITICAL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("PVZ.Cmd.Dto_CardAttributeTerm.critical","critical",8 << 3 | WireType.VARINT);
      
      public static const TOUGH:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("PVZ.Cmd.Dto_CardAttributeTerm.tough","tough",9 << 3 | WireType.VARINT);
      
      public static const IMMUNE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("PVZ.Cmd.Dto_CardAttributeTerm.immune","immune",10 << 3 | WireType.VARINT);
      
      public static const SPEED:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Dto_CardAttributeTerm.speed","speed",11 << 3 | WireType.VARINT);
      ...
      private var shield$field:Int64;
      ...
      public function set shield(param1:Int64) : void
      {
         this.shield$field = param1;
      }
      
      public function get shield() : Int64
      {
      ...
      override public final function writeToBuffer(param1:WritingBuffer) : void
      {
         ...
         if(this.hasShield)
         {
            ...
            WriteUtils.write$TYPE_INT64(param1,this.shield$field);
         }
         if(this.hasAbility)
         {
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc14_ >> 3)
            {
               ...
               case 4:
                  ...
                  _loc6_++;
                  this.shield = ReadUtils.read$TYPE_INT64(param1);
                  break;
               case 5:
                  if(_loc7_ != 0)
                  {
