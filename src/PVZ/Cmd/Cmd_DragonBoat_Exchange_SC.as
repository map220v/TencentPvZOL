package PVZ.Cmd
{
   ...
   public final class Cmd_DragonBoat_Exchange_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_DragonBoat_Exchange_SC";
      
      public static const ITEM:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_DragonBoat_Exchange_SC.item","item",1 << 3 | WireType.LENGTH_DELIMITED,Dto_IdNum);
      
      public static const CREDIT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_DragonBoat_Exchange_SC.credit","credit",2 << 3 | WireType.VARINT);
      
      public static const ACTIVITYID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_DragonBoat_Exchange_SC.activityid","activityid",3 << 3 | WireType.VARINT);
      ...
      public function Cmd_DragonBoat_Exchange_SC()
      {
         super();
      }
      ...
      {
         return Cmd_DragonBoat_Exchange_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc6_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_DragonBoat_Exchange_SC.item cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_DragonBoat_Exchange_SC.credit cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_DragonBoat_Exchange_SC.activityid cannot be set twice.");
                  }
                  _loc5_++;
