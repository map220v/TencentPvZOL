package PVZ.Cmd
{
   ...
   public final class Cmd_Puppet_Swap_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Puppet_Swap_SC";
      
      public static const SRCBASEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Puppet_Swap_SC.srcBaseId","srcBaseId",1 << 3 | WireType.VARINT);
      
      public static const DSTBASEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Puppet_Swap_SC.dstBaseId","dstBaseId",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_Puppet_Swap_SC()
      {
         super();
      }
      ...
      {
         return Cmd_Puppet_Swap_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Puppet_Swap_SC.srcBaseId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Puppet_Swap_SC.dstBaseId cannot be set twice.");
                  }
                  _loc4_++;
