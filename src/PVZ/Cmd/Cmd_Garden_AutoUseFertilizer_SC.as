package PVZ.Cmd
{
   ...
   public final class Cmd_Garden_AutoUseFertilizer_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Garden_AutoUseFertilizer_SC";
      
      public static const AUTOUSE:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("PVZ.Cmd.Cmd_Garden_AutoUseFertilizer_SC.autouse","autouse",1 << 3 | WireType.VARINT);
      
      public static const FERTILIZERID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Garden_AutoUseFertilizer_SC.fertilizerid","fertilizerid",2 << 3 | WireType.VARINT);
      ...
      public function Cmd_Garden_AutoUseFertilizer_SC()
      {
         super();
      }
      ...
      {
         return Cmd_Garden_AutoUseFertilizer_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Garden_AutoUseFertilizer_SC.autouse cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Garden_AutoUseFertilizer_SC.fertilizerid cannot be set twice.");
                  }
                  _loc4_++;
