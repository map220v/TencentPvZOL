package PVZ.Cmd
{
   ...
   public final class Cmd_Card_ResetGene_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Card_ResetGene_SC";
      
      public static const CARDUID:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Cmd_Card_ResetGene_SC.cardUId","cardUId",1 << 3 | WireType.VARINT);
      
      public static const CARDGENE:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_Card_ResetGene_SC.cardGene","cardGene",2 << 3 | WireType.LENGTH_DELIMITED,Dto_CardGene);
      ...
      public function Cmd_Card_ResetGene_SC()
      {
         super();
      }
      ...
      {
         return Cmd_Card_ResetGene_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Card_ResetGene_SC.cardUId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Card_ResetGene_SC.cardGene cannot be set twice.");
                  }
                  _loc4_++;
