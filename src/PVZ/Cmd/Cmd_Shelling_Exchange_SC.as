package PVZ.Cmd
{
   ...
   public final class Cmd_Shelling_Exchange_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_Shelling_Exchange_SC";
      
      public static const EXCHANGEID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Shelling_Exchange_SC.exchangeId","exchangeId",1 << 3 | WireType.VARINT);
      
      public static const ITEMLIST:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_Shelling_Exchange_SC.itemList","itemList",2 << 3 | WireType.LENGTH_DELIMITED,Dto_IdNum);
      
      public static const TICKET:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("PVZ.Cmd.Cmd_Shelling_Exchange_SC.ticket","ticket",3 << 3 | WireType.VARINT);
      ...
      public function Cmd_Shelling_Exchange_SC()
      {
         this.itemList = [];
         super();
      }
      ...
      {
         return Cmd_Shelling_Exchange_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Shelling_Exchange_SC.exchangeId cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 3:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_Shelling_Exchange_SC.ticket cannot be set twice.");
                  }
                  _loc4_++;
