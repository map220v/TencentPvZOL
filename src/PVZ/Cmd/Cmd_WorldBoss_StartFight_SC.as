package PVZ.Cmd
{
   ...
   public final class Cmd_WorldBoss_StartFight_SC extends Message
   {
      
      public static const $MessageID:String = "PVZ.Cmd.Cmd_WorldBoss_StartFight_SC";
      
      public static const REPORT:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("PVZ.Cmd.Cmd_WorldBoss_StartFight_SC.report","report",1 << 3 | WireType.LENGTH_DELIMITED,Dto_FightReport);
      
      public static const CURDAMAGE:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Cmd_WorldBoss_StartFight_SC.curDamage","curDamage",2 << 3 | WireType.VARINT);
      
      public static const ALLDAMAGE:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("PVZ.Cmd.Cmd_WorldBoss_StartFight_SC.allDamage","allDamage",3 << 3 | WireType.VARINT);
      ...
      public function Cmd_WorldBoss_StartFight_SC()
      {
         super();
      }
      ...
      {
         return Cmd_WorldBoss_StartFight_SC.$MessageID;
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc6_ >> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_WorldBoss_StartFight_SC.report cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_WorldBoss_StartFight_SC.curDamage cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: Cmd_WorldBoss_StartFight_SC.allDamage cannot be set twice.");
                  }
                  _loc5_++;
