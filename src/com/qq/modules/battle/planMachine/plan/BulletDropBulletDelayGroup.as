package com.qq.modules.battle.planMachine.plan
{
   ...
   public class BulletDropBulletDelayGroup extends BattleBasePlan
   {
      ...
      public function BulletDropBulletDelayGroup()
      {
      ...
      override public function setDynamicParams(param1:Array) : void
      {
         ...
         this.bulletHitEffectName = param1[1];
         this.isCompletePlayBulletAnmi = param1[2] == 1;
         var _loc2_:int = 2;
      ...
      override public function doPlan(param1:ICallBack) : void
      {
         ...
         while(_loc5_ < _loc2_)
         {
            ...
            {
               _loc4_ = new BulletDropPlanLine();
               _loc7_ = [damageList[_loc5_]];
               _loc4_.setStaticParams([actor,_loc7_,planGroup]);
               _loc4_.setDynamicParams([this.bulletName,this.bulletHitEffectName,this.isCompletePlayBulletAnmi]);
