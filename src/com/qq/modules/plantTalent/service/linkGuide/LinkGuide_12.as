package com.qq.modules.plantTalent.service.linkGuide
{
   ...
   public class LinkGuide_12 extends BasicLinkGuide implements ILinkGuide
   {
      ...
      override public function linkTo() : void
      {
         ...
         CardViewCmd.showMainWd(CardGlobals.CARD_SCENE_TYPE_EQUIPMENT,_loc3_);
      ...
      private function onLinkGuideHandler(param1:CommonEvent) : void
      {
         ...
         if(event.param.type == TalentAdvancedConditionType.EQUIP_COLOR_NUM)
         {
            ...
            {
               clearTimeout(t);
               LinkGuideView.instance.showGuide(disObj.parent.parent.parent,new Rectangle(disObj.x + 450,disObj.y + 70,disObj.width,disObj.height),"提升装备品阶",LinkGuideView.DIR_DOWN);
            },300);
         }
      }
