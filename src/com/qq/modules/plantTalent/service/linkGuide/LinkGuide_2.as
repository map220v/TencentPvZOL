package com.qq.modules.plantTalent.service.linkGuide
{
   ...
   public class LinkGuide_2 extends BasicLinkGuide implements ILinkGuide
   {
       
      
      public function LinkGuide_2()
      {
         super();
      }
      ...
      private function onLinkGuideHandler(param1:CommonEvent) : void
      {
         ...
         if(event.param.type == TalentAdvancedConditionType.LEVEL)
         {
            ...
            {
               clearTimeout(t);
               LinkGuideView.instance.showGuide(disObj.parent.parent,new Rectangle(disObj.x + 10,disObj.y + 10,disObj.width,disObj.height),"提升小镇等级",LinkGuideView.DIR_RIGHT);
            },300);
         }
      }
