package com.qq.modules.plantTalent.service.linkGuide
{
   ...
   public class LinkGuide_7 extends BasicLinkGuide implements ILinkGuide
   {
      ...
      override public function linkTo() : void
      {
         ...
         CardViewCmd.showMainWd(CardGlobals.CARD_SCENE_TYPE_FORGE,_loc3_);
      ...
      private function onLinkGuideHandler(param1:CommonEvent) : void
      {
         ...
         if(event.param.type == TalentAdvancedConditionType.PLANT_STRENGTHEN_LEVEL)
         {
            ...
            {
               clearTimeout(t);
               LinkGuideView.instance.showGuide(disObj.parent,new Rectangle(disObj.x,disObj.y,disObj.width,disObj.height),"提升植物强化等级",LinkGuideView.DIR_UP);
            },300);
         }
      }
