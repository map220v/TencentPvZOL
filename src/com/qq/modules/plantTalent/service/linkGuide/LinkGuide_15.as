package com.qq.modules.plantTalent.service.linkGuide
{
   ...
   public class LinkGuide_15 extends BasicLinkGuide implements ILinkGuide
   {
       
      
      public function LinkGuide_15()
      {
         super();
      }
      ...
      private function onLinkGuideHandler(param1:CommonEvent) : void
      {
         ...
         if(event.param.type == TalentAdvancedConditionType.GARDEN_POT_LEVEL)
         {
            ...
            {
               clearTimeout(t);
               LinkGuideView.instance.showGuide(disObj.parent,new Rectangle(disObj.x - 5,disObj.y - 5,disObj.width + 10,disObj.height + 10),"升级或购买花盆",LinkGuideView.DIR_LEFT);
            },300);
         }
      }
