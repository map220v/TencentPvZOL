package com.qq.modules.plantTalent.service.linkGuide
{
   ...
   public class LinkGuide_11 extends BasicLinkGuide implements ILinkGuide
   {
      ...
      private function onLinkGuideHandler(param1:CommonEvent) : void
      {
         ...
         if(event.param.type == TalentAdvancedConditionType.EQUIP_LEVEL)
         {
            ...
            {
               clearTimeout(t);
               LinkGuideView.instance.showGuide(disObj.parent.parent.parent,new Rectangle(disObj.x + 450,disObj.y + 70,disObj.width,disObj.height),"提升装备等级",LinkGuideView.DIR_DOWN);
            },300);
         }
      }
