package com.qq.modules.plantTalent.service.linkGuide
{
   ...
   public class LinkGuide_6 extends BasicLinkGuide implements ILinkGuide
   {
      ...
      override public function linkTo() : void
      {
         ...
         CardViewCmd.showMainWd(CardGlobals.CARD_SCENE_TYPE_PUZZLE,_loc3_);
      ...
      private function onLinkGuideHandler(param1:CommonEvent) : void
      {
         ...
         if(event.param.type == TalentAdvancedConditionType.PLANT_PUZZLE_LEVEL)
         {
            ...
            {
               clearTimeout(t);
               LinkGuideView.instance.showGuide(disObj.parent,new Rectangle(disObj.x,disObj.y,disObj.width,disObj.height),"提升植物拼图等级",LinkGuideView.DIR_UP);
            },300);
         }
      }
