package com.qq.modules.levelselect.view.components
{
   ...
   public class LSChallengePromotionBonusCell extends LSChallengePromotionBonusCellCE
   {
      ...
      public function LSChallengePromotionBonusCell(param1:Class = null, param2:Boolean = true)
      {
      ...
      override public function InitializeComponent() : void
      {
         ...
         this.l_rank.SetStyle("color","#ffffff");
         this.l_date.SetStyle("fontSize","17");
         this.l_date.SetStyle("color","#ffffff");
         var _loc1_:int = 0;
         while(_loc1_ < 1)
         {
            ...
            addChild(_loc2_);
            _loc2_.x = this["img_item"].x - 4;
            _loc2_.y = this["img_item"].y - 3;
            _loc1_++;
         }
