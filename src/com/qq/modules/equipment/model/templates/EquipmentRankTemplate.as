package com.qq.modules.equipment.model.templates
{
   ...
   import com.qq.modules.equipment.model.templates.ce.EquipmentRankTemplateCE;
   
   public class EquipmentRankTemplate extends EquipmentRankTemplateCE
   {
      ...
      public function EquipmentRankTemplate()
      {
         super();
      }
      ...
      public function get material() : ItemVO
      {
         ...
         {
            this.m_material = ItemVO.createByString(_originalMaterial,":");
         }
