package com.qq.modules.td.logic.action.plant.basic
{
   ...
   public class PlantActionAttackIdle extends BasicPlantAction
   {
       
      
      private var _idleLabelNames:Array;
      
      public function PlantActionAttackIdle()
      {
         super();
      }
      ...
      private function getActionLabelName() : String
      {
         ...
         if(_gameObject != null)
         {
            if(this._idleLabelNames == null)
            {
               ...
               {
                  if((_loc6_ = (_loc5_ = _loc2_[_loc4_]).indexOf(TDConstant.PlantAnmi_Attack_idle)) != -1 && _loc6_ == 0)
                  {
