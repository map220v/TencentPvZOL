package com.qq.modules.td.logic.action.plant.basic
{
   ...
   public class PlantActionIdle extends BasicPlantAction
   {
       
      
      private var _idleLabelNames:Array;
      
      public function PlantActionIdle()
      {
         super();
      }
      ...
      override public function enterState(param1:Array = null) : void
      {
         ...
         if(param1 != null)
         {
            this._idleLabelNames = param1[0] as Array;
         }
      ...
      private function getActionLabelName() : String
      {
         ...
         if(_gameObject != null)
         {
            if(this._idleLabelNames == null)
            {
               ...
               {
                  if((_loc6_ = (_loc5_ = _loc2_[_loc4_]).indexOf(TDConstant.PlantAnmi_Idle)) != -1 && _loc6_ == 0)
                  {
