package com.qq.modules.td.logic.action.plant.melonpult
{
   ...
   public class PMelonpultActionShoot extends BasicPlantAction
   {
       
      
      public function PMelonpultActionShoot()
      {
         super();
      }
      ...
      {
         (_gameObject as BasicPlant).runAI(true);
      }
   }
}
