package com.qq.modules.td.logic.action.zombie.basic
{
   ...
   public class ZombieActionStun extends BasicZombieAction
   {
       
      
      private var _startTime:int;
      
      private var _stunTime:int = 12000;
      
      private var _isStuning:Boolean;
      
      public function ZombieActionStun()
      {
         super();
      }
      ...
      private function onFinishStunStart(param1:Event) : void
      {
         ...
         _gameObject.animation.gotoAndPlay("stun_idle",true);
      }
