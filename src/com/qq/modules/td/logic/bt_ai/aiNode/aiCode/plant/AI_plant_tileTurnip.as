package com.qq.modules.td.logic.bt_ai.aiNode.aiCode.plant
{
   ...
   public class AI_plant_tileTurnip extends BasePlantNodePvz
   {
       
      
      public function AI_plant_tileTurnip(param1:int = 30)
      {
         super(param1);
      }
      ...
      {
         ExePlantAttack.calculate(selfObj,TDConstant.PTileTurnipAction_Attack);
         return true;
      }
   }
}
