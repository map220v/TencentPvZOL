package com.qq.modules.td.logic.bt_ai.aiNode.aiCode.plant
{
   ...
   public class AI_plant_icebean extends BasePlantNodePvz
   {
       
      
      public function AI_plant_icebean(param1:int = 30)
      {
         super(param1);
      }
      ...
      {
         ExePlantAttack.calculate(selfObj,TDConstant.PIcebeanAction_Explode);
         return true;
      }
   }
}
