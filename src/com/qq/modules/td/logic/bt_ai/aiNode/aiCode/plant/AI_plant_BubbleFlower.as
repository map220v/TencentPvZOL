package com.qq.modules.td.logic.bt_ai.aiNode.aiCode.plant
{
   ...
   public class AI_plant_BubbleFlower extends BaseNodePvz
   {
       
      
      public function AI_plant_BubbleFlower(param1:int = 30)
      {
         super(param1);
      }
      ...
      override public function calculate() : Boolean
      {
         ...
         {
            ExeDoAction.calculateStatic(selfObj,TDConstant.PBubbleFlower_Attack);
         }
         else
         {
