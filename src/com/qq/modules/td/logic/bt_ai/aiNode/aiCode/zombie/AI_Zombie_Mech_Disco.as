package com.qq.modules.td.logic.bt_ai.aiNode.aiCode.zombie
{
   ...
   public class AI_Zombie_Mech_Disco extends BaseZombieNodePvz
   {
       
      
      public function AI_Zombie_Mech_Disco(param1:int = 30)
      {
         super(param1);
      }
      ...
      override public function calculate() : Boolean
      {
         ...
         {
            ExeDoAction.calculateStatic(selfObj,TDConstant.ZAction_MechDisco_Dance);
         }
