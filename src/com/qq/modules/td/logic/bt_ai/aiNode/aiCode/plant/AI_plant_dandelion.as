package com.qq.modules.td.logic.bt_ai.aiNode.aiCode.plant
{
   ...
   public class AI_plant_dandelion extends BaseNodePvz
   {
       
      
      private var castTimes:int = 0;
      
      public function AI_plant_dandelion()
      {
         super();
      }
      ...
      override public function calculate() : Boolean
      {
         ...
         {
            if(ReqPlantCurAction.calculate(selfObj,true,TDConstant.DandelionAttackAction))
            {
               return true;
            }
            ...
            if(ReqPlantDurationExpire.calculate(selfObj) && TDSearchTargetUtils.searchTargetForPlant(selfObj as BasicPlant,_loc1_,_loc2_).length > 0)
            {
               ExePlantResetDuration.calculate(selfObj);
               ExePlantAttack.calculate(selfObj,TDConstant.DandelionAttackAction,[_loc1_]);
               return true;
            }
