package com.qq.modules.td.logic.bt_ai.aiNode.aiCode.plant
{
   ...
   public class AI_plant_bowling extends BaseNodePvz
   {
       
      
      public function AI_plant_bowling()
      {
         super();
         TDChallengeScoreManager.instance.addScoreByType(TDChallengeScoreType.Use_Bowling);
      }
      ...
      override public function calculate() : Boolean
      {
         ...
         ExePlantAttack.calculate(selfObj,TDConstant.PPotatoBowlingAction_Roll,[this.getAttackPath()]);
         return true;
      }
