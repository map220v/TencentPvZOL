package com.qq.modules.td.view.components
{
   ...
   public class TDRollingCardCE extends QCanvas
   {
      ...
      public function TDRollingCardCE(param1:Class = null, param2:Boolean = true)
      {
         super(!!param2 ? (!!param1 ? param1 : TDRollingCardMediator) : null);
      }
