package com.qq.modules.td.view.chooseCard.endlessTD
{
   ...
   public class TDCardAllListPanelWithEndlessTDMediator extends BasicScreenMediator
   {
       
      
      [Inject]
      public var view:TDCardAllListPanelWithEndlessTD;
      ...
      public function TDCardAllListPanelWithEndlessTDMediator()
      {
         super();
      }
      ...
      override protected function initListener() : void
      {
         ...
         addContextListener(CommandName.TDGameEvent_EndlessTD_BackToChooseCardScreen,this.onEnterChooseCardScreen,CommonEvent);
         addContextListener(CommandName.TD_EndlessTD_CancelChoosePlantCard,this.onCancelChooseCard,CommonEvent);
      ...
      {
         var _loc4_:int = 0;
         var _loc5_:TDChooseCardWithEndlessTD = null;
         this.cleanCardInfo();
         ...
         while(_loc4_ < _loc3_)
         {
            _loc5_ = new TDChooseCardWithEndlessTD(param1[_loc4_]);
      ...
      private function getCardPos(param1:TDCardData) : Point
      {
         ...
         while(_loc3_ < _loc4_)
         {
            if((_loc5_ = this.view.getChildAt(_loc3_) as TDChooseCardWithEndlessTD).cardData.id == param1.id)
            {
               _loc2_.x = _loc5_.x;
               _loc2_.y = _loc5_.y;
               break;
      ...
      private function onCancelChooseCard(param1:CommonEvent) : void
      {
         ...
         var _loc2_:TDBeChoosedCardWithEndlessTD = param1.readCustomParam("chooseCard") as TDBeChoosedCardWithEndlessTD;
         if(!_loc2_)
         {
      ...
      private function onAddUnlockPlantToChoose(param1:CommonEvent) : void
      {
         ...
         var unlockCard:TDUnlockCardWithEndlessTD = e.param as TDUnlockCardWithEndlessTD;
         card = new TDChooseCardWithEndlessTD(unlockCard.cardData);
      ...
      private function onPlayUnlockCardEffectComplete(param1:TDBasicChooseCard) : void
      {
         param1.alpha = 1;
      }
   }
