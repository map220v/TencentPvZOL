package com.qq.modules.td.view.chooseCard.endlessTD
{
   ...
   public class TDExternCardChoosenListPanelWithEndless extends QCanvas
   {
      ...
      public function TDExternCardChoosenListPanelWithEndless(param1:Class = null)
      {
         super();
         this.initUI();
         RobotlegExtendCmd.registerMapView(TDExternCardChoosenListPanelWithEndless,TDExternCardChoosenListPanelWithEndlessMediator);
