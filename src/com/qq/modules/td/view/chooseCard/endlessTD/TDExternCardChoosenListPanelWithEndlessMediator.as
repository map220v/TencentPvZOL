package com.qq.modules.td.view.chooseCard.endlessTD
{
   ...
   public class TDExternCardChoosenListPanelWithEndlessMediator extends BasicScreenMediator
   {
       
      
      [Inject]
      public var view:TDExternCardChoosenListPanelWithEndless;
      
      private var cardList:Vector.<TDBeChoosedCardWithEndlessTD>;
      
      public function TDExternCardChoosenListPanelWithEndlessMediator()
      {
         super();
      }
      ...
      {
         this.initListener();
         this.cardList = new Vector.<TDBeChoosedCardWithEndlessTD>();
      ...
      {
         removeContextListener(CommandName.TD_EndlessTD_ChooseCard,this.onChooseCardHandler,CommonEvent);
      ...
      private function addCardHandler(param1:CommonEvent) : void
      {
         ...
         if(TDGameInfo.getInstance().normalCardsData.slotCardData.length > TDStageInfo.getInstance().originalCardSlotNum.get() && _loc2_ == 0)
         {
            ...
            TDGameCmd.changeRain(-_loc4_.cardData.plantStaticInfo.baseInfo.costWater);
         }
      }
