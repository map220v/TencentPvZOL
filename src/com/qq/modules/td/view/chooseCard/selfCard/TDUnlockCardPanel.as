package com.qq.modules.td.view.chooseCard.selfCard
{
   ...
   public class TDUnlockCardPanel extends Container
   {
      ...
      public function TDUnlockCardPanel()
      {
         super();
         RobotlegExtendCmd.registerMapView(TDUnlockCardPanel,TDUnlockCardPanelMediator);
