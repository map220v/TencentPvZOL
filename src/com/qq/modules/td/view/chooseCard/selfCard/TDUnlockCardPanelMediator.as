package com.qq.modules.td.view.chooseCard.selfCard
{
   ...
   public class TDUnlockCardPanelMediator extends BasicScreenMediator
   {
       
      
      [Inject]
      public var view:TDUnlockCardPanel;
      
      private var _curPage:int;
      
      public function TDUnlockCardPanelMediator()
      {
         super();
      }
      ...
      private function refreshCardList() : void
      {
         ...
         while(_loc2_ < this.view.cardContainer.columnCount)
         {
            if((this._curPage - 1) * this.view.cardContainer.columnCount + _loc2_ < _loc1_.length)
            {
               ...
               _loc6_ = new TDUnlockCard(TDUnlockCardMediator,_loc5_);
