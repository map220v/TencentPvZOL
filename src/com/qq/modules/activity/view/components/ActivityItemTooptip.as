package com.qq.modules.activity.view.components
{
   ...
   import com.qq.modules.activity.view.ActivityItemTooptipMediator;
   import com.qq.modules.bag.model.vo.ItemVO;
   import com.qq.utils.UrlManager;
   
   public class ActivityItemTooptip extends QCanvas implements IToolTip
   {
      ...
      public function ActivityItemTooptip(param1:Class = null, param2:Boolean = true)
      {
         super(ActivityItemTooptipMediator);
      }
      ...
      public function set text(param1:Object) : void
      {
         ...
         (getMediator() as ActivityItemTooptipMediator).updateInfo(new ItemVO(_loc2_));
      }
   }
}
